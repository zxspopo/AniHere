...
<meta name="description" content="AniHere! 中国传媒大学 动画与数字艺术学院 学生日常作品库">
<meta name="author" content="中国传媒大学 动画与数字艺术学院">
<meta name="keywords" content="AniHere,中国传媒大学,动画与数字艺术学院,日常作品,结课作业,动画,中传,动院,数字媒体,动画学院" />
...
<form class="navbar-search pull-left" action="/ajax/search.php" method="POST">
                ...
                <!-- 分享 -->
					...
					<? } else { ?>
                    <a href="#reg" role="button" class="btn btn-block btn-red" style="height:30px;width:40px;margin-right:5px; float:left" data-toggle="modal">注册</a>
					<a href="#login" role="button" class="btn btn-block btn-red" style="height:30px;width:40px;float:left" data-toggle="modal">登录</a></div>
					<? } ?>
