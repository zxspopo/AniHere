    ...
    <div class="container" style="margin:30px auto 20px auto">
      ...
      <div id="title" style="padding:20px;">
		...
		<div class="hr2"></div>
            ...
            <div class="tabbable" style="padding-left:20px"> <!-- Only required for left/right tabs -->
                ...
                <div class="tab-pane active" id="tab1">
                  ...
                  <input type="hidden" id="id" name="id" value="<?=$visitor->id?>" />
                            <div class="control-group">
                                ...
                                <div class="controls2">
                                    <input class="input-xlarge" id="schoolid" name="schoolid" type="text" readonly value="<?=$visitor->schoolid?>" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label2" for="input01">姓名 </label>
                                <div class="controls2">
                                    <input class="input-xlarge" id="schoolname" name="schoolname" type="text" readonly value="<?=$visitor->schoolname?>" />
                                </div>
                            </div>
